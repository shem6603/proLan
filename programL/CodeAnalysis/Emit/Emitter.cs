...
namespace programL.CodeAnalysis.Emit
{
    internal sealed class Emitter
    {
        ...
        private Emitter(string moduleName, string[] references)
        {
            ...
            TypeReference ResolveType(string? programLName, string metadataName)
            {
                ...
                {
                    _diagnostics.ReportRequiredTypeNotFound(programLName, metadataName);
                }
                else
                {
                    _diagnostics.ReportRequiredTypeAmbiguous(programLName, metadataName, foundTypes);
                }
