...
using programL.CodeAnalysis.Text;
using Mono.Cecil;
...
namespace programL.CodeAnalysis
{
    internal sealed class DiagnosticBag : IEnumerable<Diagnostic>
    {
        ...
        public void ReportRequiredTypeNotFound(string? programLName, string metadataName)
        {
            var message = programLName == null
                ? $"The required type '{metadataName}' cannot be resolved among the given references."
                : $"The required type '{programLName}' ('{metadataName}') cannot be resolved among the given references.";
            ReportError(default, message);
        }

        public void ReportRequiredTypeAmbiguous(string? programLName, string metadataName, TypeDefinition[] foundTypes)
        {
            ...
            var message = programLName == null
                ...
                : $"The required type '{programLName}' ('{metadataName}') was found in multiple references: {assemblyNameList}.";
            ReportError(default, message);
        }
